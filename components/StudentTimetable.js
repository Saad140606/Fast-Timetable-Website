        ...
        <div className={styles.headerContent}>
          ...
          <div className={styles.creatorInfo}>
            ...
            <div className={styles.socialLinks}>
              <a href="https://github.com/Saad140606" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} title="GitHub">
              ...
              <a href="https://www.linkedin.com/in/syed-saad-najam-02546a302" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} title="LinkedIn">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
